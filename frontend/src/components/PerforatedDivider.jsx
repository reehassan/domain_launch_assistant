...
export default function PerforatedDivider() {
  return (
    <div className="relative -mx-6">
      ...
      <span className="absolute left-0 top-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-paper" />
      <span className="absolute right-0 top-1/2 h-4 w-4 translate-x-1/2 -translate-y-1/2 rounded-full bg-paper" />
    </div>
  );
}
